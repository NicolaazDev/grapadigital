...
export default function LoginPage() {
  return (
    <div className="flex items-center justify-between h-screen lg:justify-center md:justify-center sm:justify-center">
      ...
      <div className="flex items-center justify-center w-[30%] max-w-[550px] min-w-[540px] sm:min-w-[100%] h-full px-7 !overflow-hidden bg-[#ffffff] lg:w-[100%] lg:min-w-fit lg:max-w-[300px] md:w-[100%] md:min-w-fit md:max-w-[300px]">
        <div className="flex flex-col items-center justify-center gap-4 w-full  sm:!w-[100vw]">
          <img
            src="/assets/images/logo.svg"
            alt="logo"
            className="w-[90%] max-h-[100px]"
          />
          <h1
